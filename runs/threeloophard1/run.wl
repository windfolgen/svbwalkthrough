(* =================================================================== *)
(*  Bootstrap Run: threeloophard1                                        *)
(*                                                                     *)
(*  Integrand: (x[5,6]*x[3,4] - x[3,6]x[4,5] - x[3,5]x[4,6])          *)
(*             / (12 propagators with 5,6,7)                            *)
(*  LS: 1/(z-zz)^2,  n=2,  poleType="double"                            *)
(*  Ansatz: threeloophard1_ans.m  (43 elements, even parity)             *)
(* =================================================================== *)

$HistoryLength = 0;

(* ---- directory layout ---- *)
runDir   = DirectoryName[$InputFileName];           (* runs/threeloophard1/ *)
...
ansatzExpr = Import[FileNameJoin[{runDir, "threeloophard1_ans.m"}]];
...
RunSeriesExpansion[rootDir, label, lsAddPole, poleType, weightN, yOrder, svIndices, mplIndices, 2, mplBasisFile];
