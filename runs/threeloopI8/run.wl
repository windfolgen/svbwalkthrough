...
(*                                                                     *)
(*  Integrand: x[1,4]x[2,3] / (12 propagators with 5,6,7)              *)
(*  LS: v/(z-zz)^3,  n=2,  poleType="simple"                           *)
...
(* ---- directory layout ---- *)
runDir   = DirectoryName[$InputFileName];           (* runs/threeloopI8/ *)
...
poleType = "simple";
lsAddPole = v / ((1 + u - v)^2 - 4 u);  (* base = v/(z-zz)^2 *)
order = 3;
yOrder = 4;
...
Print["Non-zero: ", Select[Transpose[{Range[30], values}], #[[2]] =!= 0 &] // TableForm];
