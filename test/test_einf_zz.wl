...
(* User approach for SeriesExpansionInf with zz Expansion *)
test2 = expr /. {f[5]->Zeta[5],f[7]->Zeta[7],f[3]->Zeta[3],P[0]->-Log[u]};
(* Expand in zz going to Infinity, so it gives negative powers of zz *)
test2 = test2 * Normal[Series[1/(z-zz), {zz, Infinity, 15}]];
...
Print["Diff if expanding 1/(z-zz) around zz=Infinity: ", InputForm[Expand[res1 - res2]]];
