...
Export["data/allsvliste1_uptow8_inuv_mirror.txt", ToString[InputForm[res1], PageWidth -> Infinity], "String"];
Print["Finished e1uv."];
...
Export["data/allsvliste1_uptow8_inuvp_mirror.txt", ToString[InputForm[res1P], PageWidth -> Infinity], "String"];
...
Export["data/allsvliste0_uptow8_inuv_mirror.txt", ToString[InputForm[res0], PageWidth -> Infinity], "String"];
Print["Finished e0uv."];
...
Export["data/allsvliste0_uptow8_inuvp_mirror.txt", ToString[InputForm[res0P], PageWidth -> Infinity], "String"];
