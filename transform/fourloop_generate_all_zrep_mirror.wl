(* fourloop_generate_all_zrep_mirror.wl *)
$HistoryLength = 0;
...
Print["Importing four-loop datasets..."];
evaluatedMPL0 = Import["data/allsvlistmpl_fourloop_invzze0.m"];
evaluatedMPL1 = Import["data/allsvlistmpl_fourloop_invzze1.m"];
...
Export["data/allsvlistmpl_fourloop_invzze1_inuv_mirror.txt", ToString[InputForm[res1], PageWidth -> Infinity], "String"];
Print["Finished e1uv."];
...
Export["data/allsvlistmpl_fourloop_invzze1_inuvp_mirror.txt", ToString[InputForm[res1P], PageWidth -> Infinity], "String"];
...
Export["data/allsvlistmpl_fourloop_invzze0_inuv_mirror.txt", ToString[InputForm[res0], PageWidth -> Infinity], "String"];
Print["Finished e0uv."];
...
Export["data/allsvlistmpl_fourloop_invzze0_inuvp_mirror.txt", ToString[InputForm[res0P], PageWidth -> Infinity], "String"];
