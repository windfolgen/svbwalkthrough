...
(* I3Lhardr integrand *)
$I3LhardrInt = x[1, 3]*x[2, 4]*(x[3, 6]*x[4, 5] + x[3, 5]*x[4, 6])/(x[1, 5]*x[1, 6]*x[2, 5]*x[2, 6]*x[3, 5]*x[3, 6]*x[3, 7]*x[4, 5]*x[4, 6]*x[4, 7]*x[5, 7]*x[6, 7]);

$PERMS = {{1, 2, 3, 4}, {1, 3, 2, 4}, {2, 1, 3, 4}, {2, 3, 1, 4}, {3, 1, 2, 4}, {3, 2, 1, 4}};

RunAsymExpansionParallel["I3Lhardr", $I3LhardrInt, $PERMS, 3, {5, 6, 7}];
