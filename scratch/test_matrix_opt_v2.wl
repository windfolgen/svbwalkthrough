...
Print["If False, check difference: ", Expand[tpRaw1 - tpRawFromGen[[1]]] === Table[0, {Length[tpRaw1]}]];
...
tOpt = SessionTime[];
(* Optimized contraction: coeffHashed = mat . (tempHashed) *)
coeffHashed = mat . (tempHashed);
