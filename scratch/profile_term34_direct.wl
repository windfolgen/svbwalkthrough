...
t0 = SessionTime[];
res = ProjectTensor[{result[[k]]}, p, top1, top2, "check" -> False, "profile" -> True, "dir" -> FileNameJoin[{rootDir, "asym", "tmp", "test_profile_dir34"}]];
Print["ProjectTensor for term ", k, " took: ", SessionTime[] - t0, "s"];
