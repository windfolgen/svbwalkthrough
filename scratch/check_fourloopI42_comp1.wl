...
integrand1 = (x[1,7]*x[2,4]*x[3,4]*x[5,6])/
...
Print["=== Term count check for fourloopI42 comp1 ==="];
...
Do[
  ...
  Do[
    intCase = integrand1 /. {x[a__] :> (x[a] /. Thread@Rule[{1, 2, 3, 4}, c])};
    Quiet[
    ...
    Print["Permutation: ", perm, " | Case: ", c, " | RegionExpand: ", reTerms, " | ToTensorProduct: ", totTerms];
  , {c, cases}];
, {i, 1, Length[perms]}];
