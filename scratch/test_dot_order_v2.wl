...
(* Custom GenTensorProjection definition that matches the matrix format *)
...
,
  rep = {};
  tp = GenTensorProjectionNew[tem, p];
];
...
t1 = tpReplaced[[1]] . (tempHashed /. rep);
t2 = (tempHashed /. rep) . Transpose[tpReplaced[[1]]];

Print["t1 === t2 ? ", t1 === t2];
Print["Dimensions of t1: ", Dimensions[t1]];
Print["Dimensions of t2: ", Dimensions[t2]];
