...
k = 4034;
Print["=== result[[4034]] ==="];
Print["Length[result[[k]]]: ", Length[result[[k]]]];
Print["result[[k, 1]]: ", result[[k, 1]]];
Print["result[[k, 2]] vc list: ", Cases[{result[[k, 2]]}, vc[__], Infinity] // DeleteDuplicates];
Print["result[[k, 3]] vc list: ", Cases[{result[[k, 3]]}, vc[__], Infinity] // DeleteDuplicates];
Print["result[[k, 4]] loops: ", result[[k, 4]]];
