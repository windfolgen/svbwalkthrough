...
Print["matA dimensions: ", Dimensions[matA]];
Print["matDirect dimensions: ", Dimensions[matDirect]];
Print["Does Transpose[matDirect] === matA? ", Expand[Transpose[matDirect] - matA] === Table[0, {l}, {l}]];
Print["Does matDirect === matA? ", Expand[matDirect - matA] === Table[0, {l}, {l}]];
Print["matA[[1]]: ", matA[[1]]];
Print["matDirect[[1]]: ", matDirect[[1]]];
Print["Transpose[matDirect][[1]]: ", Transpose[matDirect][[1]]];
