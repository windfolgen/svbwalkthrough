...
Print["Unique tensor structures in topology 1: ", Length[unique1]];
Print["Unique tensor structures in topology 2: ", Length[unique2]];
Print["Total unique tensor structures: ", Length[allUnique]];
...
Print["Cache hits: ", hits, "/", Length[allUnique]];
Print["Cache misses: ", Length[misses]];
If[Length[misses] > 0,
  Print["First few misses: ", Short[misses, 5]];
];
